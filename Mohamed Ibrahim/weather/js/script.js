...
const getValues = (event) => { 
    ...
    if (city === '') {
        ...
        if (language == 'sv') {
            ...
            todayName = 'இப்போது வானிலை, ';
            apparentName = 'உணர்வது: ';
            windName = 'காற்று: ';
            pressureName = 'அழுத்தம்: ';
            humidityName = 'ஈரப்பதம்: ';
            dayNames = ['ஞாயிற்றுக்கிழமை','திங்கட்கிழமை' ,'செவ்வாய்க்கிழமை', 'புதன்கிழமை', 'வியாழக்கிழமை','வெள்ளிக் கிழமை', 'சனிக்கிழமை']; 
        }
        spinnerLogoDiv.style.display = 'none';
        getWeather(city);
        message.innerText = '';
