...
function displayCityInfo() {
    ...
    $.ajax({
        ...
        var imageURL = "https://w7.pngwing.com/pngs/981/554/png-transparent-weather-forecasting-rain-weather-winter-text-weather-forecasting-thumbnail.png" + imgCode + ".png";
    ...
    $.ajax({
        ...
        wf += "<h2 id='dynah2' class='card-header'>" + response.city.name + " Five-Day Forecast" + "</h2>";
            $.each(response.list, function (index, val) {
                ...
                var Farenheit = Math.floor((Kelvin - 273.15) );
                wf += "<div class='card-text'>" + Farenheit + "&degC" + "</div><br>"; // Temperature
